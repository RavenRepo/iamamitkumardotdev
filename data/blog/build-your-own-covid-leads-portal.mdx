...
Initially, [covidrescue.co.in](https://covidrescue.co.in/) was hosted on [Vercel](https://vercel.com/) and I personally love Vercel. Almost all of my projects are hosted on Vercel including [iamamitkumar.dev](https://iamamitkumar.dev/) But there were a few issues:
