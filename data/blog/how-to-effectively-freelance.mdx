...
- It helps your website rank on Google because with [Next.js](https://nextjs.org) you can build server side rendered applications.
...
- It comes with API routes to help you get up and running with back-end tasks.
  I built [tailwindmasterkit.com](https://tailwindmasterkit.com) with Next.js completely. TMK is a components and templates marketplace that is feature rich. Comes with a dashboard and a playground to test your components as well. So the use case is proven and it just works.
...
better. It doesn’t matter if the [projects](https://iamamitkumar.dev/projects) are commercial/paid projects or just
...
I built a [free portfolio template](https://simple-developer-portfolio-website.vercel.app) for you to use (If you use React) - That does exactly that - showcase your personality and work. [Here’s the link to the blog](https://www.freecodecamp.org/news/how-to-build-a-portfolio-site-with-nextjs-tailwindcss/) that I wrote on the same.
...
[Blogging](https://iamamitkumar.dev/blog) has single handedly helped me position myself as an expert in web
development on the internet. When you have blogs on your website (or you write
blogs for other websites like [FreeCodeCamp](https://freecodecamp.com) or [LogRocket](https://logrocket.com)
...
recently wrote a [blog on Box Shadows](https://www.freecodecamp.org/news/how-to-create-beautiful-box-shadows-in-html-and-css/) and I realised I never truly understood box
...
- Explaining what I built recently. For example: I built [iamamitkumar.dev/boxshadows](https://iamamitkumar.dev/boxshadows) - Here’s how I did it. (Include live preview and source code).
...
[GitHub](https://github.com/ravenrepo) is one of the major “This guy is an expert” indicator in this field. Not only
...
I [tweet](https://twitter.com/growthperclick) about almost everything and
anything. Whatever I learn or whatever I see on the internet, I either Tweet or
share something on [LinkedIn](https://linkedin.com/in/growthperclick). Clients are all over the place and Social Media
websites are one of them. 
...
1. [Upwork](http://upwork.com)
2. [Codementor](http://codementor.io)
3. [My own personal website](http://iamamitkumar.dev)
4. Cold emailing
...
I'm planning to write a whole blog on how to get clients on Upwork (Strategies that worked for me). Keep on visiting the [blog's page](https://iamamitkumar.dev/blog) and I’ll be sure to keep you updated.
...
[Follow me on twitter: @growthperclick](https://twitter.com/growthperclick) if you are interested in memes, shitposting and random tech wisdom.
