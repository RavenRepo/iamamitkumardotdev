...
export default async function InspirationPage() {
  const items = [
    ...
    {
      title: "Klack",
      description: "A benchmark for polished UX with clear product communication.",
    ...
    },
    {
      ...
      description: "Motion and interaction references I reuse in product UI.",
    ...
    {
      title: "Shadcn UI",
      description: "My default UI stack for building MVP interfaces fast.",
    ...
    {
      title: "Tailwind Plus",
      description: "Production-ready patterns that reduce front-end iteration time.",
    ...
    {
      title: "Posthog",
      description: "My analytics backbone for activation, retention, and experiments.",
    ...
    {
      title: "Fireship",
      description: "Fast technical context that keeps execution speed high.",
    ...
    {
      title: "Autosend",
      description: "Great example of sharp positioning and conversion-focused landing design.",
  ...
  return (
    <>
      <Container className="min-h-screen">
        ...
        <p className="text-foreground pt-4 text-base">
          I optimize for fast MVPs, clear positioning, analytics-led iteration,
          and distribution from day one.
        </p>
